...
export default function AIProblemGenerator() {
    ...
    const generateAIProblem = async () => {
        ...
        try {
            const response = await fetch(`http://localhost:8001/api/v1/openai/generate_problem?grade_level=${studentLevel}&difficulty=${selectedDifficulty}&topic=${selectedTopic}&custom_prompt=${encodeURIComponent(customPrompt)}`, {
                method: 'GET',
                headers: {
